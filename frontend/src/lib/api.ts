...
export const api = {
  ...
  generateSchedule: (payload: {student_code: string; term_code: string; subject_ids: string[]; preferences: SchedulePreference[]; campus_pref?: "ALL" | "CS1" | "CS2"; custom_days?: number[]; allow_heavy_days?: boolean; program_type?: "STANDARD" | "HIGH_QUALITY" | "TALENT" | "PFIEV"}) =>
